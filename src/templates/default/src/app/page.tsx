...
export default function Home() {
  ...
  // TEST: Remove this line after testing ErrorBoundary
          ...
          <div className="max-w-4xl mx-auto w-full">
            ...
            <div className="mb-12 sm:mb-16 space-y-8 sm:space-y-6">
              <div className="flex items-start sm:items-center text-left">
                <span
                  className={`text-xl sm:text-2xl mr-4 sm:mr-6 flex-shrink-0 font-medium ${theme === "light" ? "text-black" : "text-white"}`}
                >
                  1.
                </span>
                <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
                  <span
                    className={`text-lg sm:text-xl md:text-2xl ${theme === "light" ? "text-black" : "text-white"}`}
                  >
                    Start with
                  </span>
                  <code
                    className={`px-4 py-2 rounded-xl text-sm sm:text-base font-mono inline-block w-fit ${theme === "light" ? "bg-gray-100 text-black border border-gray-200" : "bg-white/10 text-white border border-white/10"}`}
                  >
