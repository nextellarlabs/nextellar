...
export default function Home() {
    ...
    return (<div className="h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        {theme === 'light' ? (<Image src="/ligt-mode-bg.svg" alt="Light mode background" fill className="object-cover" priority onError={() => { }}/>) : (<Image src="/dark-mode-bg.svg" alt="Dark mode background" fill className="object-cover" priority onError={() => { }}/>)}
      </div>
