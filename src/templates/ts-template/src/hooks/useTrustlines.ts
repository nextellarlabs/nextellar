...
/**
 * Options for the useTrustlines hook
 */
export interface UseTrustlinesOptions {
  horizonUrl?: string;
  network?: 'TESTNET' | 'PUBLIC';
}

/**
 * Return type for the useTrustlines hook
 */
...
export function useTrustlines(
   ...
   */
  const fetchTrustlines = useCallback(async (key: string): Promise<Trustline[]> => {
