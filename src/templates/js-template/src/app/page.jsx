...
export default function Home() {
  ...
  const [bgImgError, setBgImgError] = useState({ light: false, dark: false });
          ...
          <div className="max-w-4xl mx-auto w-full">
            ...
            <div className="mb-12 sm:mb-16 space-y-8 sm:space-y-6">
              <div className="flex items-start sm:items-center text-left">
                <span className={`text-xl sm:text-2xl mr-4 sm:mr-6 flex-shrink-0 font-medium ${theme === "light" ? "text-black" : "text-white"}`}>
                  1.
                </span>
