 ...
 *
 * TransactionList Component Tests — js-defi template
 */
...
jest.unstable_mockModule(
  "../../src/templates/js-defi/src/hooks/useTransactionHistory",
  () => ({
...
const [{ default: TransactionList }, { useTransactionHistory }, { useWallet }] =
  await Promise.all([
    import("../../src/templates/js-defi/src/components/TransactionList"),
    import("../../src/templates/js-defi/src/hooks/useTransactionHistory"),
...
describe("TransactionList (js-defi template)", () => {
  beforeEach(() => {
    jest.clearAllMocks();
